...
return {
	...
	config = function()
		...
		vim.keymap.set('n', '<leader>ghn', function() gitsigns.nav_hunk('next') end, { desc = "[g]it [h]unk [n]ext" })
		vim.keymap.set('n', '<leader>ghp', function() gitsigns.nav_hunk('prev') end, { desc = "[g]it [h]unk [p]rev" })
