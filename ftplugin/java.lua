...
config.on_attach = function(_, bufnr)
	...
	vim.keymap.set('n', '<Leader>jbt', function() require('dap').toggle_breakpoint() end,
		{ noremap = true, silent = true, buffer = bufnr, desc = "Toggle Breakpoint" }
	)

	vim.keymap.set('n', '<Leader>jbs', function() require('dap').set_breakpoint() end,
		{ noremap = true, silent = true, buffer = bufnr, desc = "Set Breakpoint" }
	)

	vim.keymap.set('n', '<Leader>jro', function() require('dap').repl.open() end,
	...
	vim.keymap.set({ 'n', 'v' }, '<Leader>jdh', function()
		...
		{ noremap = true, silent = true, buffer = bufnr, desc = "Widgets Hover" }
	)

	vim.keymap.set({ 'n', 'v' }, '<Leader>jdp', function()
			require('dap.ui.widgets').preview()
		end,
		{ noremap = true, silent = true, buffer = bufnr, desc = "Widgets Preview" }
	)
	...
	vim.keymap.set('n', '<Leader>jdf', function()
		...
		{ noremap = true, silent = true, buffer = bufnr, desc = "Widgets Centered" }
	)
